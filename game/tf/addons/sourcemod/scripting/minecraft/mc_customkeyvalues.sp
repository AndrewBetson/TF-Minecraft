...
public void OnPluginStart_CKV()
{
	g_EntityKeyValues = new EntityMap();
}

// NOTE(AndrewB): The massive char array causes a heap size error, so this has been replaced with OnMapStart.
//public Action OnLevelInit( const char[] mapname, char mapEntities[2097152] )
public void OnMapStart_CKV()
{
